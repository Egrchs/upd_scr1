...
typedef struct packed {
    ...
    logic [`SCR1_FPRF_AWIDTH-1:0]      frs1_addr;      // ????? ????????? 1 FPU
    logic [`SCR1_FPRF_AWIDTH-1:0]      frs2_addr;      // ????? ????????? 2 FPU
    logic [`SCR1_FPRF_AWIDTH-1:0]      frs3_addr;      // ????? ????????? 3 FPU (??? FMA)
    logic [`SCR1_FPRF_AWIDTH-1:0]      frd_addr;       // ????? ?????????? FPU
} type_scr1_exu_cmd_s;
