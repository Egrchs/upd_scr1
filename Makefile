...
# ======================================================================
#   АВТОМАТИЧЕСКОЕ ОПРЕДЕЛЕНИЕ ТУЛЧЕЙНА И ПУТЕЙ
# ======================================================================

# --- 1. Автоматическое определение префикса кросс-компилятора ---
...
# --- 2. Автоматический поиск путей к библиотекам и заголовкам ---
